...
<div class="row">
  ...
  <div class="btn-toolbar float-right">
     ...
     <button class="btn btn-primary" style="margin:5px;" style="" > <a style="color: #fff;" href="addtool.php"> Add Tool </a> </button>
  
    <button class="btn btn-primary" style="margin:5px;"> <a style="color: #fff;" href="DownloadExcel.php">  Excel Download </a>  </button>
        ...
        <table id="tableMain"> 
            ...
            <tr > 
                ...
                <td><a href="toolinformation.php?id=<?php echo $rows['id'];?>">View</a> ||<a href="table.php?del=<?php echo $rows['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');"> Delete</a></td>
            </tr> 
